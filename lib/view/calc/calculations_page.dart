...
import 'package:flutter_calculate/view/calc/calc_bloc.dart';
import 'package:flutter_calculate/view/calc/calc_button.dart';
import 'package:flutter_calculate/resource/calc_colors.dart';
import 'package:provider/provider.dart';

import '../../data/model/calculation.dart';
import '../../domain/interactor/calculations_interactor.dart';
import '../../domain/repository/calculations_repository.dart';
import '../../data/data_provider/hive_data_provider.dart';
...
class _CalculationsPageState extends State<CalculationsPage> {
  ...
  void initState() {
    ...
    final CalculationsRepository calculationsRepository = CalculationsRepository(hiveDataProvider.calculationsBoxProvider);
    final CalculationsInteractor calculationsInteractor = CalculationsInteractor(calculationsRepository);
        ...
        builder: (context, snapshot) {
          ...
          return Container(
            ...
            child: Text(
              expression,
              style:
                  TextStyle(fontSize: 32, color: CalcColors.primaryTextColor),
            ),
          );
        });
  }
        ...
        builder: (context, snapshot) {
          ...
          return Container(
            ...
            child: Text(
              result,
              style:
                  TextStyle(fontSize: 40, color: CalcColors.primaryTextColor),
            ),
          );
        });
  }
